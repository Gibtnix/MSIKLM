...
# this script will modify the file '/etc/rc.local' to activate the respective configuration at startup
# additionally it will create a wakeup script that activates the respective configuration after wakeup from standy
# finally, it can also undo both steps by calling it with the '--disable' argument
